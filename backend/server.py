...
# actual_horizontal_angle = None
# actual_vertical_angle = None
...
#     if actual_vertical_angle == None or actual_horizontal_angle == None:
#         return jsonify({"error": "An oopsie occurred, no gyatt for you"}), 400
       
#     horizontal_angle = data["horizontal_angle"], vertical_angle = data["verical_angle"]
...
# @app.route("/", methods=["GET", "POST"])
# def home():
#     return render_template("/Users/rui/Documents/SkyScope/frontend/index.html")
